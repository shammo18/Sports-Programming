...
int go(int a , int b , int c , int flag){
     ...
     for(int i = 1;i < 4;i++){
     	...
     	if(a + i < 26)ret = ret | go(a + i , b , c , flag^1);

     }

     for(int i = 1;i < 4;i++){
     	
     	if(b + i < 26)ret = ret | go(a , b + i , c , flag^1);

     }

     for(int i = 1;i < 4;i++){
     	
     	if(c + i < 26)ret = ret | go(a  , b , c + i, flag^1);
...
void solve(){
     ...
     cin >> s; 
     int ans = go(s[0] - 'A' , s[1] - 'A' , s[2] - 'A' , 0);
     cout << ans << endl;
