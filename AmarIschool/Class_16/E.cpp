    ...
    for(int i = 0;i < m;i++){
      ...
      //Dijkstra
       ...
       // cout << dis[t] << endl;
        ...
        if(cost[{par[tar] , tar}] == 0 && flag){
        	cost[{par[tar] , tar}] = 1 + L - dis[t];
        	cost[{tar , par[tar]}] = 1 + L - dis[t];
        	// cout << tar << " "<< par[tar] << 1 + L - dis[t]<< endl;
        	flag = false;
        }else if(cost[{par[tar] , tar}] == 0){
            cost[{par[tar] , tar}] = 1 ;
        	cost[{tar , par[tar]}] = 1 ;
        }
        ...
        int u , v;
        for(int i  =0;i < m;i++){
            if(cost[{edges[i].a , edges[i].b}] == 0 || cost[{edges[i].b , edges[i].a}] == 0){
            	w = 1e18;
            }else w = cost[{edges[i].a , edges[i].b}];
