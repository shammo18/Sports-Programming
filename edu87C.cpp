...
void solve(){
	...
	double korno = 0.5 / sin(theta);
	double y = sin(kon) * korno;
	double one = y / sin(alpha);

	cout << one << endl; //return;

	double two = 0.5 / sin(alpha);
