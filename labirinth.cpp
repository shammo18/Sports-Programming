    ...
    for(int i = 0;i < n;i++)
      ...
      while(!q.empty()){
      	  ...
      	  for(int i = 0;i < 4;i++){
      	  	  ...
      	  	  if(valid(X , Y)){
      	  	  	  if(dis[X][Y].xx > dis[u.xx][u.yy].xx + cost){
                    dis[X][Y].xx = dis[u.xx][u.yy].xx + cost;
      	  	  	  	if(cost == 0) q.push_front({X , Y});
    ...
    for(int i = 0;i < n;i++)
      ...
      while(!q.empty()){
      	  ...
      	  for(int i = 0;i < 4;i++){
      	  	  ...
      	  	  if(valid(X , Y)){
      	  	  	  if(dis[X][Y].yy > dis[u.xx][u.yy].yy + cost){
                    dis[X][Y].yy = dis[u.xx][u.yy].yy + cost;
      	  	  	  	if(cost == 0) q.push_front({X , Y});
      	  	  	  	else q.push_back({X , Y});
      	  	  	  }
      	  	  }
...
*/
    ...
    for(int i = 0;i < n;i++){
    	for(int j = 0;j < m;j++){
    		if(dis[i][j].xx <= l && dis[i][j].yy <= r) cnt++;
    	}
    }
