...
void solve(){
     ...
     vector<int> X = base_to_two(x);
     vector<int> Y = base_to_two(y);
      int g = 30 - X.size();
     ...
     for(int i = 0;i < 30;i++){
        ...
        if(n > 0){
           if(X[i] == 1)ans.pb('E');
           else if(X[i] == -1) ans.pb('W');
        }else{
           if(X[i] == 1)ans.pb('W');
           else if(X[i] == -1) ans.pb('E');
        }

        if(m > 0){
           if(Y[i] == 1)ans.pb('N');
           else if(Y[i] == -1) ans.pb('S');
        }else{
           if(Y[i] == 1)ans.pb('S');
           else if(Y[i] == -1) ans.pb('N');
        }
