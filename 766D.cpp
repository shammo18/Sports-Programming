...
*/
    ...
    for(int i = 1;i <= m;i++){
        ...
        if(t == 1){
           if(mp[r1] == r2) cout <<"NO" << endl;
           else {
           	   cout << "YES" << endl;
           	   union_sets(r1,r2);
           	   if(mp[r1] == 0 && mp[r2] == 0){
                 
           	   }else if(mp[r1] != 0 && mp[r2] != 0){
           	   	  union_sets(mp[r1],mp[r2]);
           	   	  int temp = mp[r1];
                  mp[r1] = 0;
                  mp[r2] = 0;
                  mp[find_par(r1)]   = find_par(temp);
                  mp[find_par(temp)] = find_par(r1);
           	   }else if(mp[r1] != 0){
           	   	  int temp = mp[r1];
                  mp[r1] = 0;
                  mp[find_par(r1)]   = find_par(temp);
                  ...
                  int temp = mp[r2];
                  mp[r2] = 0;
                  mp[find_par(r2)]   = find_par(temp);
                  mp[find_par(temp)] = find_par(r2);  
           	   }
        	...
        	if(r1 == r2) cout << "NO" << endl;
               ...
               if(mp[r1] == 0 && mp[r2] == 0){
                  ...
                  mp[r1] = 0;
                  mp[r2] = 0;
                  mp[find_par(r1)] = find_par(r2);
                  mp[find_par(r2)] = find_par(r1);
           	   }else if(mp[r1] != 0){
           	   	  union_sets(r2,mp[r1]);
           	   	  int temp = mp[r1];
                  mp[r1] = 0;
