...
int main(){
    ...
    for(int i = 0;i < n;i++){
        ...
        for(int j = res;j < m;j++){
        	if(rob[i].yy > arr[j].yy){
        		j--;
        		if(j < 0) mov[i] = 0;
        		else mov[i] = arr[j].xx + 1 - rob[i].xx;
        		break;
        	}
        }
    ...
    for(int i = 0;i < n;i++){
        ...
        for(int j = res;j < m;j++){
        	if(rob[i].xx > brr[j].yy){
        		j--;
        		if(j < 0) mov[i] = 0;
        		else mov[i] = min(mov[i] , brr[j].xx + 1 - rob[i].yy);
        		break;
        	}
        }
